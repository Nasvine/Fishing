        ...
        <div class="row align-items-center">
            <div class="col-sm-12">
                <div class="text-sm-center">
                    <p class="mb-0">© <script>document.write(new Date().getFullYear())</script>  FePeMAA-BENIN. Product <i class="mdi mdi-heart text-danger"></i> by <a href="#" target="_blank" class="text-reset">PACIFIC GROUP</a>.</p>
                </div>
            </div><!--end col-->
